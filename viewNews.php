...
<html lang="ar" dir="rtl">
    <head>
        <meta charset="UTF-8">
        <title>نظام إدارة الأخبار - عرض الأخبار</title>
    ...
    <body>
        <div class="main-container">
            ...
            <div class="page-header">
                <h1>عرض الأخبار</h1>
                <p>جميع الأخبار المنشورة في نظام إدارة الأخبار</p>
            </div>
                            ...
                            <?php if(mysqli_num_rows($result) > 0): ?>
                                ...
                                <?php while($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editNews.php?id=<?php echo $row['Id']; ?>" class="action-btn btn-edit" title="تعديل">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="deleteNews.php?id=<?php echo $row['Id']; ?>" class="action-btn btn-delete" title="حذف" onclick="return confirm('هل أنت متأكد من حذف هذا الخبر؟');">
        ...
        <script>
            document.querySelectorAll('.btn-delete').forEach(btn => {
                btn.addEventListener('click', function(e) {
                    if(!confirm("تأكيد الحذف: هذا الإجراء لا يمكن التراجع عنه. هل أنت متأكد")) {
                        e.preventDefault();
                    }
                });
            });
